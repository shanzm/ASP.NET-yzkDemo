...
namespace ViewVideo
    ...
    public class NVelocityHelper
    {
        ...
        public  static string RenderHtml(string templateName, object data)
        {
            ...
            vltEngine.SetProperty(RuntimeConstants.FILE_RESOURCE_LOADER_PATH, System.Web.Hosting.HostingEnvironment.MapPath("~/1.全页面刷新ViewVideo/templates/"));//模板文件所在的文件夹(注意~代表模版所在文件夹))
            vltEngine.Init();
